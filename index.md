...
Simplest use of `embed_plot`: pass in data frame and it will use the
last (in this case, only) factor column it finds and the stable built-in
...
- More example datasets that I’ve used these functions with can be found
  in the [snedata](https://github.com/jlmelville/snedata) package.
