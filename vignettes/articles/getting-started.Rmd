...
of showing categorical legends or numeric colorbars and tooltips. `text` works
for numeric colors as well; default hover text preserves original row numbers
without showing literal input colors:
